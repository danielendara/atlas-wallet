...
AirWallet is early-stage software. Security fixes target the latest released version.
...
AirWallet uses a simple 4 digit parent PIN as a family-use editing lock. It is not encryption and should not be treated as strong security.
